...
const I18N = {
  ...
  es: {
    ...
    prov_groq: "Groq (gratis, sin tarjeta)",
    prov_gemini: "Google Gemini (gratis según el país)",
    prov_anthropic: "Claude (Anthropic)",
    prov_openai: "OpenAI (GPT)",
  ...
  de: {
    ...
    prov_groq: "Groq (kostenlos, keine Karte)",
    prov_gemini: "Google Gemini (kostenlos, je nach Land)",
    prov_anthropic: "Claude (Anthropic)",
    prov_openai: "OpenAI (GPT)",
...
const DATE_LOCALES = { fr: "fr-FR", en: "en-US", es: "es-ES", de: "de-DE" };
...
function buildCorrectionSystemPrompt(fromVoice) {
  const explLang = { en: "anglais", es: "espagnol", de: "allemand" }[state.lang] || "français";
